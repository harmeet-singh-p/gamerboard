...
namespace DemoWpfApp
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void LoadUser()
        {
            try
            {
                UserViewModel userVM = new UserViewModel { CenterRanking = "1587", LoyaltyPoints = "62", UserName = "Invoker" };
                ...
                usersVM.Add(new UserViewModel { CenterRanking = "1587", LoyaltyPoints = "62", UserName = "Invoker" });
                usersVM.Add(new UserViewModel { CenterRanking = "1587", LoyaltyPoints = "62", UserName = "Invoker" });
                usersVM.Add(new UserViewModel { CenterRanking = "1587", LoyaltyPoints = "62", UserName = "Invoker" });
